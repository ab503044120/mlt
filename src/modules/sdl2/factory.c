...
extern mlt_consumer consumer_sdl2_opengl_init( mlt_profile profile, mlt_service_type type, const char *id, char *arg );
...
MLT_REPOSITORY
{
    ...
    MLT_REGISTER(mlt_service_consumer_type, "sdl2_opengl", consumer_sdl2_opengl_init);
    MLT_REGISTER_METADATA(mlt_service_consumer_type, "sdl2_opengl", metadata, "consumer_sdl2_opengl.yml");
